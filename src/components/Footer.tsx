        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-reverse space-x-3 mb-4">
              ...
              <h3 className="text-xl font-bold">أسفار أهل الخير</h3>
            </div>
            <p className="text-gray-300 leading-relaxed">
              شريكك الموثوق للرحلات الروحانية وتجارب السفر. نخلق ذكريات تدوم مدى
              الحياة.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-reverse space-x-3">
                ...
                <a href="tel:+212661495138" dir="ltr" className="text-gray-300">
                  +2126 61 49 51 38
                </a>
              </div>
              <div className="flex items-center space-x-reverse space-x-3">
              ...
              <div className="flex items-center space-x-reverse space-x-3">
                ...
                <a
                  href="mailto:voageahloelkheir@gmail.com"
                  target="_blank"
                  className="text-gray-300"
                >
                  voyageahloelkheir@gmail.com
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 mb-4 md:mb-0">
              أسفار أهل الخير جميع الحقوق محفوظة © {new Date().getFullYear()}
            </p>
